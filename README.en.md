...
🌐 **[Live Website & Web Terminal](https://p2p-filetransfer.madebybaki.com)** | 🇹🇷 **[Türkçe Dokümantasyon (README.md)](README.md)** | 🛡️ **[Security Policy](docs/SECURITY.md)** | ✉️ **[Contact](mailto:contact@madebybaki.com)**

---

## 🎯 Executive Summary

FileTransferilla is built to solve the privacy, speed, and size-limit bottlenecks of modern file sharing. Instead of uploading sensitive archives to centralized third-party servers, peers establish an authenticated direct P2P data stream.
...
Run the one-line installer for your platform to install and keep FileTransferilla continuously updated:
...
> **Portable Binaries:** Prebuilt standalone executables (`.exe`, `mac_arm64`, and `.deb`) are available directly from [GitHub Releases](https://github.com/Baaaki/P2P-FileTransfer-Project/releases/latest) and the [Project Website](https://p2p-filetransfer.madebybaki.com/#indir).
...
* **Receive:** Enter the code $\rightarrow$ Confirm transfer (files save into `Downloads/FileTransferilla`).
* **Language:** Press `[L]` to switch between English and Turkish at any time.

### 2. Headless CLI Mode
```bash
# Send directory in the background
filetransferilla -send ./backups/

# Receive code into a target directory non-interactively
filetransferilla -receive apple-port-42 -out /var/data -yes
...
* **Website:** [https://p2p-filetransfer.madebybaki.com](https://p2p-filetransfer.madebybaki.com)
