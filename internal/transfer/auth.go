...
const (
	...
	confirmReceiverLabel = "filetransferilla/pake/confirm/receiver/v1"
	confirmSenderLabel   = "filetransferilla/pake/confirm/sender/v1"
)
...
func (c Credentials) identities() (idA, idB []byte) {
	return []byte("filetransferilla/receiver/" + c.Receiver),
		[]byte("filetransferilla/sender/" + c.Sender)
}
